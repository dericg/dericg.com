...
class GFSettings {
			...
			'license_key'         => array(
				...
				'fields'      => array(
					array(
						...
						'type'                => 'text',
						'input_type'          => 'password',
						'value'               => '4308eedb-1add-43a9-bbba-6f5d5aa6b8ee',
						'placeholder'         => '4308eedb-1add-43a9-bbba-6f5d5aa6b8ee',
	...
	public static function license_key_details_callback() {
		$key          = '4308eedb-1add-43a9-bbba-6f5d5aa6b8ee';
